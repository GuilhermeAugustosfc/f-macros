...
import type RspackChain from '../../compiled/rspack-chain.js';
...
import type { EnvironmentContext, ModifyBundlerChainUtils, ModifyChainUtils, Routes } from './hooks.js';
import type { ModifyWebpackChainUtils, ModifyWebpackConfigUtils, RsbuildPlugins } from './plugin.js';
import type { RsbuildEntry, RsbuildMode, RsbuildTarget } from './rsbuild.js';
import type { BundlerPluginInstance, Rspack, RspackRule } from './rspack.js';
import type { CSSExtractOptions, CSSLoaderModulesOptions, CSSLoaderOptions, HtmlRspackPlugin, LoosePostCSSPlugin, PostCSSLoaderOptions, StyleLoaderOptions, WebpackConfig } from './thirdParty.js';
import type { ConfigChain, ConfigChainMergeContext, ConfigChainWithContext, MaybePromise, OneOrMany, TwoLevelReadonly } from './utils.js';
